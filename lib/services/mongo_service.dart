...
class MongoService {
  ...
  Future<void> connect() async {
    try {
      ...
      await _db!.open().timeout(
        ...
        onTimeout: () {
          throw Exception("Koneksi Timeout. Cek IP Whitelist (0.0.0.0/0) atau Sinyal HP.");
        },
      );
  ...
  // 2. Mengganti tipe data Logbook menjadi LogModel
  ...
  // Mengganti tipe data Logbook menjadi LogModel
